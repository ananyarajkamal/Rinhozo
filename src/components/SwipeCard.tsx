...
export const SwipeCard: React.FC<SwipeCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className={`absolute inset-0 w-full h-full flex flex-col justify-between p-6 md:p-8 rounded-3xl bg-bg-card border border-bg-elevated shadow-[0_8px_32px_rgba(30,41,59,0.06)] overflow-hidden select-none cursor-grab active:cursor-grabbing ${className}`}
    >

...
export const LandingPage: React.FC<LandingPageProps> = ({ strings, onGetStarted }) => {
  ...
  return (
    <div 
      ...
      className="relative min-h-screen text-[#1e293b] flex flex-col font-sans overflow-x-hidden perspective-3d select-none"
      style={{
    ...
    >
      ...
      <header className="w-full max-w-7xl mx-auto px-8 py-5 flex items-center justify-between z-20">
        ...
        <button 
          ...
          className="flex items-center gap-2 bg-[#1e293b] hover:bg-[#0f172a] text-white px-6 py-3 rounded-full text-xs font-bold shadow-md hover:shadow-lg transition-all group clay-button"
        >

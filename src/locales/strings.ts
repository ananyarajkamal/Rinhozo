...
export const LOCALES: Record<SupportedLang, UIStrings> = {
  hinglish: {
    ...
    styleStory: "Stories & Analogies (Real-life examples se)",
    ...
    audioToggle: "Audio Mode (Audio on/off)",
  ...
  hindi: {
    ...
    bossBattleDesc: "अगले क्षेत्र को अनलॉक करने के लिए ५ प्रश्नों के उत्तर दें।",
  ...
  english: {
    ...
    landingRinBubble: "Hi! I'm Rinhozo 👋 I'm here to guide, encourage, and learn with you — every step of the way.",
    ...
    onboardingWelcome: "Welcome to Rinhozo! Let's get to know you.",
    ...
    styleStory: "Stories & Analogies (Real-world examples & movies)",
